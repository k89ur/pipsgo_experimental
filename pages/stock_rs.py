...
with main:
    with st.container(border=True):
        ...
        with refresh:
            refresh_data = st.button("↻  Refresh Market Data", use_container_width=True, help="Discard the current market-data snapshots and download fresh data on the next scan.")
