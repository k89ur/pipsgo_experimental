...
# Keep controls/status in the top row. Results are rendered below as a full-width section
# so the available middle area is used instead of leaving a large blank region.
...
# Everything below this point is intentionally full-width. This is the Audit #11.1
# layout fix: Results now occupies the blank middle area below the top controls/status row.
top = valid.head(3)
