...
with main:
    ...
    if df is None:
        ...
        with export_col: st.download_button("↓  Export CSV",df.to_csv(index=False).encode("utf-8"),"nifty_index_rs.csv","text/csv",use_container_width=True,type="primary")
        view=df.copy()
        ...
        def style(row):
            ...
            s=f"background-color:{bg};color:{fg};font-weight:700;"; styles[si]=s; styles[ri]=s; return styles
