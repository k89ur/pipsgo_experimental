...
.stApp{background:var(--bg);color:var(--text);font-family:Inter,system-ui,sans-serif}.block-container{max-width:1500px;padding:4.15rem 1.25rem 3rem}
...
.top-brand{position:fixed;top:0;left:0;right:0;height:48px;display:flex;justify-content:center;align-items:center;background:#090c11;border-bottom:1px solid rgba(37,45,56,.55);z-index:9999;pointer-events:none}.top-brand-mark{font-size:.88rem;font-weight:800;letter-spacing:.25em;color:var(--text);line-height:1}.top-brand-mark span{color:var(--green)}
...
@media(max-width:900px){.block-container{padding:3.7rem .7rem 2rem}.leader-grid{grid-template-columns:1fr}.page-title{font-size:1.55rem}.top-brand{height:44px}.top-brand-mark{font-size:.78rem}}
</style>
