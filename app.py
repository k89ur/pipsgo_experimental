...
.page-brand{display:flex;justify-content:center;align-items:center;height:30px;margin:.05rem 0 .7rem;font-size:.9rem;font-weight:800;letter-spacing:.28em;line-height:1;color:var(--text);user-select:none}.page-brand span{color:var(--green)}
...
[data-testid="stDownloadButton"] button{border-radius:8px;border:1px solid #2e9e68;background:#35d07f;color:#07110c;font-weight:700;min-height:2.1rem;padding:.2rem .7rem;box-shadow:0 5px 16px rgba(53,208,127,.08)}[data-testid="stDownloadButton"] button:hover{background:#4be28f;border-color:#4be28f;color:#07110c}
...
@media(max-width:900px){.block-container{padding:2.7rem .7rem 2rem}.leader-grid{grid-template-columns:1fr}.page-title{font-size:1.55rem}.page-brand{height:27px;font-size:.8rem}}
</style>
