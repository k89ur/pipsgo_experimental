...
def _session():
    ...
    # Prime the NSE session and the report page so the historical API receives
    # the same cookies/referer context as the public archive page.
...
def _normalise_columns(frame):
    ...
    # Avoid duplicate canonical columns if NSE changes a response label.
